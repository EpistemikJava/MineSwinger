...
class MineSettings extends JFrame implements ActionListener {
    ...
    /**
     * CONSTRUCTOR <br>
     * called ONLY by <code>MineSwinger.startup()</code>
    ...
    MineSettings(final MineSwinger game) {
        ...
        setTitle( Msgs.str( "settings.change" ) );
    ...
    private void buildDensityPanel() {
        ...
        denHead = new JLabel( Msgs.str( "density.mine" ) );
        denInfo = new JLabel( Integer.toString( percentDensity ) + " %" );
        ...
        denSlider.addChangeListener( new ChangeListener() {
            @Override
    ...
    private void buildSizePanel() {
        ...
        sizeHead = new JLabel( Msgs.str( "size.square" ) );
        sizeGroup = new ButtonGroup();

        smallRadBtn = new JRadioButton( Msgs.str( "small" ), false );
        smallRadBtn.addActionListener( this );
        medRadBtn = new JRadioButton( Msgs.str( "Medium" ), true );
        medRadBtn.addActionListener( this );
        largeRadBtn = new JRadioButton( Msgs.str( "LARGE" ), false );
    ...
    private void buildButtonPanel() {
        // action buttons
        btnPanel = new JPanel();
        newBtn = new JButton( Msgs.str( "game.new" ) );
        sizeBtn = new JButton( Msgs.str( "size.new" ) );
        cancelBtn = new JButton( Msgs.str( "Cancel" ) );
    ...
    public void actionPerformed(final ActionEvent ae) {
        ...
        if( source == cancelBtn ) {
            ...
            if( source == newBtn )
                startNew = true;
            else if( source == sizeBtn ) startNew = false;
    ...
    void setDensity(final int percent) {
        ...
        denInfo.setText( Integer.toString( percentDensity ) + " %" );
    }
